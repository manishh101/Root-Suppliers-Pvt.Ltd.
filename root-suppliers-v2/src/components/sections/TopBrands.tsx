...
export const TopBrands: React.FC<TopBrandsProps> = ({ brands }) => {
  ...
  return (
    <section className="py-10 bg-[#c4b5a6]">
      <div className="container-main">
        ...
        <div className="relative">
          <button
            onClick={scrollPrev}
            className="absolute left-0 top-1/2 -translate-y-1/2 z-10 w-10 h-10 rounded bg-white/50 hover:bg-white/80 flex items-center justify-center transition-colors"
            aria-label="Previous"
          >
          ...
          <button
            onClick={scrollNext}
            className="absolute right-0 top-1/2 -translate-y-1/2 z-10 w-10 h-10 rounded bg-white/50 hover:bg-white/80 flex items-center justify-center transition-colors"
            aria-label="Next"
          >
                ...
                >
                  <div className="bg-white rounded-xl p-5 h-full flex items-center justify-center shadow-md hover:shadow-xl transition-all duration-300 border border-gray-100 hover:border-primary-200 group cursor-pointer relative overflow-hidden">
                    ...
                    <Image
                      ...
                      width={120}
                      height={60}
                      className="object-contain max-h-16 relative z-10 transition-all duration-300"
                    />
                  </div>
                </div>
              ))}
