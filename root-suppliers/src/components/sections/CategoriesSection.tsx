    ...
    >
      ...
      <div className="container-main relative z-10">
        ...
        <div className={`text-center mt-20 transition-all duration-1000 delay-500 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          <Link
            href="/categories"
            className="group inline-flex items-center gap-4 px-10 py-5 bg-secondary-600 text-white font-bold rounded-2xl hover:bg-secondary-700 transition-all duration-300 shadow-xl hover:shadow-secondary-200/50 transform hover:-translate-y-1 font-primary"
          >
