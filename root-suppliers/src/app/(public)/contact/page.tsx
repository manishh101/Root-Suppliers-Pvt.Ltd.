            ...
            <form className="space-y-6 bg-gray-50 p-8 md:p-10 rounded-2xl border border-gray-100" onSubmit={handleSubmit}>
              ...
              {status === "success" ? (
                <button
                  ...
                  className="w-full inline-flex items-center justify-center gap-2 px-8 py-4 bg-primary-600 text-white font-bold rounded-lg hover:bg-primary-700 transition-colors uppercase tracking-wide group"
                >
                ...
                <button
                  ...
                  className="w-full inline-flex items-center justify-center gap-2 px-8 py-4 bg-primary-600 text-white font-bold rounded-lg hover:bg-primary-700 transition-colors uppercase tracking-wide group disabled:opacity-70 disabled:cursor-not-allowed"
                >
                  {status === "loading" ? (
                    <>Processing...</>
                  ) : (
